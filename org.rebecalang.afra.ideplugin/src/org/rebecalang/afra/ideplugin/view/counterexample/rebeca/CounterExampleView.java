package org.rebecalang.afra.ideplugin.view.counterexample.rebeca;
...
import org.rebecalang.afra.ideplugin.view.counterexample.Item;
import org.rebecalang.afra.ideplugin.view.counterexample.ItemComparator;
import org.rebecalang.afra.ideplugin.view.counterexample.PropertyItem;
import org.rebecalang.afra.ideplugin.view.counterexample.QueueContent;
import org.rebecalang.afra.ideplugin.view.counterexample.RebecItem;
import org.rebecalang.afra.ideplugin.view.counterexample.RebecStatevarItem;
...
public class CounterExampleView extends ViewPart {
	private static Logger logger = Logger.getLogger(CounterExampleView.class.getName());
	...
	public void setCounterExample(CounterExampleR ce) {
		this.viewContentProvider.counterExample = ce;
	}

	class ViewContentProvider implements ITreeContentProvider {

		CounterExampleR counterExample = null;
	...
	public void createPartControl(Composite parent) {
		...
		Tree subTree = new Tree(tree, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL);
		subTree.setLinesVisible(true);
		subTree.setHeaderVisible(true);
		
		TreeColumn col = new TreeColumn(subTree, SWT.LEFT);
		col.setText("T");
		col.setWidth(200);
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				CounterExampleView.this.fillContextMenu(manager);
			}
		});
	...
	private void loadResult() {
		...
		if (selectedFile != null) {
			...
			try {
				jaxbContext = JAXBContext.newInstance(ModelCheckingReport.class);
				Unmarshaller unmarshaller = jaxbContext.createUnmarshaller();
				ModelCheckingReport report = (ModelCheckingReport) unmarshaller
						.unmarshal(resultFile);
				counterExample = new CounterExampleR("", report);
